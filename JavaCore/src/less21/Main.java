...
public class Main {
	...
	public static void main(String[] args) throws ReflectiveOperationException{
		...
		Class<?> mainClass = Class.forName("Less19.Main");
		Method main = mainClass.getMethod("main", String[].class);
//		String[] params2 = new String[0];
//		main.invoke(null, (Object)params2);
		
		main.invoke(null, (Object)args);
		
//		main.invoke(mainClass, (Object)args);
		
		Object obj = Work.class.newInstance();
		IWork iWork = (IWork)Proxy.newProxyInstance(Work.class.getClassLoader(), Work.class.getInterfaces(), new InvocationHandler(){
